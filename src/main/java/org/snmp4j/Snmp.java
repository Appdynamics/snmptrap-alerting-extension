 ...
 * a specific {@link org.snmp4j.TransportMapping} instance is added by calling the
 * {@link #addTransportMapping(org.snmp4j.TransportMapping transportMapping)} method or
...
public class Snmp implements Session, CommandResponder {
   ...
   *    {@link org.snmp4j.TransportMapping#listen()} method has been called.
   */
   ...
   * @since 1.1
   * @see org.snmp4j.MessageDispatcher#getNextRequestID
   */
   ...
   * {@link #send(org.snmp4j.PDU pdu, org.snmp4j.Target target)} method.
   * @param pdu
   *    a <code>PDU</code> instance. For SNMPv3 messages, the supplied PDU
   *    instance has to be a <code>ScopedPDU</code> instance.
   * @param target
   ...
   * is a convenience wrapper for the  {@link #send(org.snmp4j.PDU pdu, org.snmp4j.Target target)}
   * method.
   * @param pdu
   ...
   * Please use {@link #send(org.snmp4j.PDU pdu, org.snmp4j.Target target)} instead. It returns
   * a {@link org.snmp4j.event.ResponseEvent} object holding the response PDU and transport
   ...
   *    <code>pdu</code> is a confirmed PDU and the request is either answered
   *    or timed out.
   * @deprecated Please use {@link #send(org.snmp4j.PDU pdu, org.snmp4j.Target target, Object
   *    userHandle, org.snmp4j.event.ResponseListener listener)} instead. It has exactly
   ...
   *    a mesage processing model ID as defined in {@link org.snmp4j.mp.MessageProcessingModel}.
   ...
   * @see #setTimeoutModel(org.snmp4j.TimeoutModel timeoutModel)
   */
  ...
  class NotificationDispatcher implements CommandResponder {
     ...
     * @throws
     *    org.snmp4j.MessageException if the response could not be created and sent.
     */
