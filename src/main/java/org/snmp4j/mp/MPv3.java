...
public class MPv3
  ...
  /**
   * Creates a MPv3 with a supplied local engine ID and {@link org.snmp4j.util.PDUFactory}
   * for incoming messages.
   * @param localEngineID
   *    the local engine ID. Its length must be >= 5 and <= 32.
   * @param incomingPDUFactory
   *    a {@link org.snmp4j.util.PDUFactory}. If <code>null</code> the default factory will be
   *    used which creates {@link org.snmp4j.ScopedPDU} instances.
   * @since 1.9.1
   */
   ...
   * MPv3 is necessary if multiple {@link org.snmp4j.Snmp} instances are used within a VM.
   * @param usm
   *    an USM instance.
   * @since 1.10
   */
   ...
   *    {@link org.snmp4j.security.SecurityProtocols#getInstance()}.
   * @param secModels
   ...
   * @see org.snmp4j.security.SecurityProtocols#addDefaultProtocols()
   */
   ...
   * storage and fires the corresponding {@link org.snmp4j.event.SnmpEngineEvent}.
   * @param address
   *    the <code>Address</code> of the remote SNMP engine.
   * @return
   ...
   * corresponding {@link org.snmp4j.event.SnmpEngineEvent}.
   * @param address
  ...
  protected static class Cache {
     ...
     * @return
     *    {@link org.snmp4j.mp.SnmpConstants#SNMP_MP_DOUBLED_MESSAGE} if the entry already
     *    exists and {@link org.snmp4j.mp.SnmpConstants#SNMP_MP_OK} on success.
     */
...
*/
   ...
   * @return
   *    a security model ID.
   * @see org.snmp4j.security.USM#getID()
   */
   ...
   * @return
   *    a {@link org.snmp4j.ScopedPDU} instance by default.
   * @since 1.9.1
   */
  public PDU createPDU(Target target) {
    return new ScopedPDU();
