...
public class TableUtils extends AbstractSnmpUtility {
   ...
   * @return
   *    a <code>List</code> of {@link org.snmp4j.util.TableEvent} instances. Each instance
   ...
   * performance.
   * <p>
   * This method may call the {@link org.snmp4j.util.TableListener#finished} method before
   ...
   *    are supplied in this array!
   * @param listener
   *    a <code>TableListener</code> that is called with {@link org.snmp4j.util.TableEvent}
